/**
 * Get listings for an item with specific intent from database
 * @param {Object} db - Database connection instance
 * @param {string} name - Item name
 * @param {string} intent - Listing intent ('buy' or 'sell')
 ...
 * @param {Object} db - Database connection instance
 * @param {Function} updateListingStats - Function to update listing statistics
 * @param {Object} response_item - Item details
 * @param {string} sku - Item SKU
 * @param {Object} currencies - Price in currencies
 * @param {string} intent - Listing intent ('buy' or 'sell')
 * @param {string} steamid - Steam ID of listing owner
 ...
 * @param {string} name - Item name
 * @param {string} intent - Listing intent ('buy' or 'sell')
 * @returns {Promise<Object[]>} Deleted listings
 */
...
/** Maximum age in seconds for listings before deletion (5 days) */
const HARD_MAX_AGE_SECONDS = 5 * 24 * 60 * 60;

/**
 * Delete old listings based on activity bands
 * @param {Object} db - Database connection instance
 * @returns {Promise<void>}
 */
