...
- **Price Stability:** Uses internal price history and moving averages to prevent dramatic price swings and ensure stable pricing.
...
```JSON
{
  ...
  "priceSwingLimits": {                    // Prevent dramatic price changes
    "maxBuySwing": 0.15,                   // 15% max change for buy prices
    "maxSellSwing": 0.15                   // 15% max change for sell prices
  },
